package me.sores.impulse.util.moreprojectiles.projectile;

import me.sores.impulse.Impulse;
import me.sores.impulse.util.moreprojectiles.TypedRunnable;
import me.sores.impulse.util.moreprojectiles.event.CustomProjectileHitEvent;
import me.sores.impulse.util.moreprojectiles.event.ItemProjectileHitEvent;
...
public class ItemProjectile extends EntityItem implements IProjectile, CustomProjectile<ItemProjectile> {
    ...
    public static FixedMetadataValue meta = new FixedMetadataValue(Impulse.getInstance(), true);
