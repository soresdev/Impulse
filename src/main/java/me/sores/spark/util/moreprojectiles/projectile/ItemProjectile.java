...
import me.sores.spark.util.moreprojectiles.event.ItemProjectileHitEvent;
...
public class ItemProjectile extends EntityItem implements IProjectile, CustomProjectile<ItemProjectile> {
    ...
    public static FixedMetadataValue meta = new FixedMetadataValue(Spark.getInstance(), true);
